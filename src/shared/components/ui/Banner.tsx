...
export default function Banner() {
  return (
    <div className="flex bg-[url('@/assets/images/banner.png')] bg-cover bg-center rounded-[16px] h-[370px] text-white">
      <div className="flex flex-col w-full bg-gradient-to-b justify-center items-center from-black/28 to-transparent rounded-[16px]">
        ...
        <p className="title-20 mb-[30px]">
          이메일부터 메신저까지, 각종 알림으로 장애 발생을 빠르게 알려요.
        </p>
        <Button
          asChild
          variant={"basic"}
          className="bg-white text-black title-20_SB w-[214px] h-[50px] rounded-[12px] hover:bg-primary hover:text-white"
        >
